...
<body>
         ...
         $res=$con->query($SEl);
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="..\Assets\Files\Distimg\<?php echo $row['dist_img'];?>" width="100" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" style="border-radius:50%; width:100px; height:100px;" src="..\Assets\Files\Distimg\<?php echo $row['dist_img'];?>"  alt="Profile image">
  ...
  <i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i>My Profile <span class="badge badge-pill badge-danger"></span></a>
