...
$disitd=$_SESSION['distid'];
if(isset($_POST["btnsubmit"])){
$comtitle=$_POST["txtcomtitle"];
$comcontent=$_POST["txtcomcontent"];
$insqry="insert into tbl_complaint(complaint_title,complaint_content,dist_id) values('".$comtitle."','".$comcontent."',".$disitd.")";
if($con->query($insqry))
{
...
<table class="table table-bordered table-striped">
  ...
  <tbody>
    <?php
    $selc = "SELECT * FROM tbl_complaint where dist_id=" . $disitd;
    $resc = $con->query($selc);
    $i = 0;
