...
<?php
        ...
        if (isset($_POST["btn_checkout"]) != "") {
               ...
               $upQry = "update tbl_booking set booking_date=curdate(),booking_total='".$amt."',booking_status='1' where user_id='" .$_SESSION['uid']. "'and booking_id='".$rsc["booking_id"]."'";
...
<form method="post">
        ...
        $(".product-quantity input").change(function() {
            $.ajax({
                url: "../Assets/AjaxPages/AjaxToolCart.php?action=Update&id=" + this.alt + "&qty=" + this.value
            });
            updateQuantity(this);
        ...
        $(".product-removal button").click(function() {
            ...
            $.ajax({
                url: "../Assets/AjaxPages/AjaxToolCart.php?action=Delete&id=" + this.value
            });
            removeItem(this);
        });
