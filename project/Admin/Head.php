      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="index.html">
            <img src="../Assets/Template/Admin/imges//logo.svg" alt="logo" />
          </a>
          <a class="navbar-brand brand-logo-mini" href="index.html">
            <img src="../Assets/Template/Admin/imges//logo-mini.svg" alt="logo" />
          </a>
        </div>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text"><span class="text-black fw-bold"></h1>
         ...
         $res=$con->query($SEl);
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="../Assets/Files/adminphoto/logo (2).jpg" width="100px" height="100px"  alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="../Assets/Files/adminphoto/logo (2).jpg" width="100px" height="100px"  alt="Profile image">
                <p class="mb-1 mt-3 font-weight-semibold"> <?php echo $row['admin_name'] ;?></p>
                <p class="fw-light text-muted mb-0"> <?php echo $row['admin_email'] ;?></p>
              </div>
