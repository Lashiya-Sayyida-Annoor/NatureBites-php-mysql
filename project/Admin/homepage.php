    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <a class="navbar-brand brand-logo" href="index.html">
                <h1 class="fw-bold text-primary m-0" height="30px"  width="30px">Nature<span class="text-secondary"><br>Bites</span></h1>
            </a>
         ...
         $res=$con->query($SEl);
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="../Assets/Files/adminphoto/<?php echo $row['admin_img'];?>"
                width="100" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="../Assets/Files/adminphoto/<?php echo $row['admin_img'];?>"
                  width="100" width="100px" height="100px" alt="Profile image">
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              <li class="list active">
                <div class="profile"><img src="../Assets/Template/Admin/imges//faces/face1.jpg" alt="image"><span
              ...
              <li class="list">
                <div class="profile"><img src="../Assets/Template/Admin/imges//faces/face2.jpg" alt="image"><span
              ...
              <li class="list">
                <div class="profile"><img src="../Assets/Template/Admin/imges//faces/face3.jpg" alt="image"><span
                    class="online"></span></div>
                <div class="info">
                  <p>Daniel Russell</p>
                  <p>Available</p>
              ...
              <li class="list">
                <div class="profile"><img src="../Assets/Template/Admin/imges//faces/face4.jpg" alt="image"><span
                    class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="../Assets/Template/Admin/imges//faces/face5.jpg" alt="image"><span
                    class="online"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="../Assets/Template/Admin/imges//faces/face6.jpg" alt="image"><span
                    class="online"></span></div>
                <div class="info">
                  <p>Sarah Graves</p>
                  <p>Available</p>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic1">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="DistributorVerification.php">Farmer Verifying</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic2" aria-expanded="false"
              aria-controls="ui-basic">
              <i class="menu-icon mdi mdi-floor-plan"></i>
              <span class="menu-title">Add and Manage</span>
              <i class="menu-arrow"></i>
            </a>
            ...
            <div class="collapse" id="ui-basic2">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="VegCategory.php">Category</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="replycomplaint.php">Replay Complaints</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="farmerOrderPie.php">Farmer Order</a></li>
                <li class="nav-item"> <a class="nav-link" href="UserBar (1).php">category Ways sale </a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="report.php">Stock Report</a></li>
                <li class="nav-item"> <a class="nav-link" href="SalesReport.php">Sales Report</a></li>
              ...
              <div class="card border shadow-xs mb-4">
                <div class="card-body text-start p-3 w-100" style="width:400px;">
                  <div
                    ...
                    <svg width="16" height="40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                      fill="currentColor">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="w-100">
                        <h5 class="text-sm text-secondary display-8 mb-7">Registered Distributor</h5>

                        <div class="d-flex align-items-center">

                          <span class="text-sm text-success font-weight-bolder">
                            <?php
                $sel = "SELECT count(dist_id) as cid FROM tbl_distributor WHERE dist_status = 1";
              ...
              <div class="card border shadow-xs mb-4">
                <div class="card-body text-start p-3 w-100" style="width:400px;">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="w-100">
                        <h5 class="text-sm text-secondary display-8 mb-7">Registered user</h5>
                  ...
                  <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card">
                    <div class="card card-rounded">
                      <div class="card-body">
                          ...
                          <iframe src="./UserBarCon.php" style="width: 100%; height: 500px;"></iframe>
                          <iframe src="./PieChart.php" style="width: 100%; height: 500px;"></iframe>
                            ...
                            //   $sel1 = "select sum(cart_quantity) as id from tbl_cart ca inner join  tbl_booking b  on b.booking_id=ca.booking_id inner join  tbl_vegetables p on ca.veg_id=p.veg_id inner join tbl_vegcategory c on c.vegcat_id=p.vegcat_id WHERE c.vegcat_id='".$data["vegcat_id"]."'";
