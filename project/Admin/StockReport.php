        ...
        <table id="example" class="table  table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">Stocking Date</th>
			...
			<?php
                ...
                $selQ = "SELECT * FROM tbl_distributor d inner join tbl_vegetables v on d.dist_id=v.dist_id inner join tbl_vegstock vs on vs.veg_id=v.veg_id";
                $resQ = $con->query($selQ);
                while($dataQ = $resQ->fetch_assoc())
                {
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $dataQ["veg_name"]; ?></td>
                            <td><?php echo $dataQ["batch_id"]; ?></td>
                            <td><?php echo $dataQ["vegstock_quant"]; ?></td>
                           
                           
                            <td><?php echo $dataQ["stocking_date"]; ?></td>
                            <td><?php echo $dataQ["expiry_date"]; ?></td>
                            <td><?php echo $dataQ["damage_veg"]; ?></td>
