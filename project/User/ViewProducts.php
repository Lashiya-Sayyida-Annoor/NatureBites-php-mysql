                ...
                <div class="col-lg-3">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" onclick="productCheck()" class="form-check-input product_check" value="<?php echo $row["vegcat_id"]; ?>" id="category"><?php echo $row["vegcat_name"]; ?>
                                </label>
                            </div>
                        </li>
                        <?php
...
<script src="../Assets/Template/Search/popper.min.js"></script>
        <script>
            ...
            function productCheck(){
                    ...
                    const dist_id = urlParams.get("disid");
                    ...
                    $.ajax({
                        url: "../Assets/AjaxPages/AjaxViewProduct.php?action=" + action +"&category=" + category+"&dist_id=" + dist_id+"&name=" + name ,
                        success: function(response) {
