...
<table  align="center"cellspacing="60" id="result">
  <br><br>
        ...
        <tr>
       <?php	  
	   $select="select *from tbl_tool dt inner join tbl_toolcategory p on p.toolcat_id=dt.toolcat_id where dt.toolcat_id='".$_GET["pid"]."'";
	...
	<a href="Searchtool.php"> Add Cart </a>
